...
| **OSCAR-2021** | Common Crawl | [website](https://oscar-project.org/)| 3,91,947 samples | None (Monolingual corpus) (has word language probabilties and text and footer labels) | Language Modelling, Text Summarization (Note: Used by Muril) | 
| **Wikipedia** | Wikipedia | [website](https://www.tensorflow.org/datasets/catalog/wikipedia#wikipedia20230601gor)| 32,885 Samples |  None (Monolingual corpus) (has text and title labels) | Language Modelling, Text Summarization (Note: Used by Muril) |
<!-- 
