...
| **IndicCorp V2** | AI4Bharat | [paper](https://arxiv.org/abs/2212.05409) | 852 tokens, 14.8 GB  | None	Largest monolingual corpus for 24 Indic languages. Nepali data is included, focusing on clean and diverse text. Built from sources like Wikipedia, news, blogs, and government documents | Base corpus of IndicBERTv2 | Language Modeling, Pretraining, Fine-Tuning | 
| **OSCAR-2021** | Common Crawl | [website](https://oscar-project.org/)| 3,91,947 samples | None (Monolingual corpus) (has word language probabilties and text and footer labels) |  Used by Muril | Language Modelling, Text Summarization | 
| **Wikipedia** | Wikipedia | [website](https://www.tensorflow.org/datasets/catalog/wikipedia#wikipedia20230601gor)| 32,885 Samples |  None (Monolingual corpus) (has text and title labels) | Used by Muril | Language Modelling, Text Summarization |
<!-- 
